...
public class AgregarAsistente extends javax.swing.JFrame {
    ...
    public AgregarAsistente() {
        initComponents();
        AgregarAsistente.agregarFacultad(comboFacultad);
        AgregarAsistente.agregarPrograma(comboFacultad, comboPrograma);
    }
    ...
    private void initComponents() {
        ...
        btnAgregarAsistente = new javax.swing.JButton();
        ...
        getContentPane().add(contraseñaPersonal, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 240, 410, 30));
        ...
        btnAgregarAsistente.setBackground(new java.awt.Color(191, 13, 13));
        btnAgregarAsistente.setFont(new java.awt.Font("Poppins", 1, 11)); // NOI18N
        btnAgregarAsistente.setForeground(new java.awt.Color(255, 255, 255));
        btnAgregarAsistente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/agregar-estudiante.png"))); // NOI18N
        btnAgregarAsistente.setText("Agregar Asistente");
        btnAgregarAsistente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnAgregarAsistenteMouseClicked(evt);
            }
        });
        btnAgregarAsistente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAgregarAsistenteActionPerformed(evt);
            }
        });
        getContentPane().add(btnAgregarAsistente, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 390, 210, 60));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/agregar-asistente.png"))); // NOI18N
    ...
    private void btnAgregarAsistenteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarAsistenteMouseClicked
        
    }//GEN-LAST:event_btnAgregarAsistenteMouseClicked

    private void btnAgregarAsistenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarAsistenteActionPerformed
        com.model.Admin admin = new com.model.Admin();
        String mensaje = admin.agregarAsistente(identificacionPersonal.getText().toString(), 
    ...
    }//GEN-LAST:event_btnAgregarAsistenteActionPerformed
    ...
    private javax.swing.JButton btnAgregarAsistente;
